...
const wordDatabase = [
  ...
  { korean: "~에서 기인하다", english: "result from" },
  { korean: "연속, 순서", english: "sequence" },
  { korean: "각성된 상태로 있다", english: "remain alert" },
  { korean: "맡다, 떠맡다", english: "undertake" },
  ...
  { korean: "흑백 논리의", english: "simplistic" },
  { korean: "내장된, 타고난", "english": "inherent" },
  { korean: "잡담하다, 대화하다", english: "converse" },
  ...
  { korean: "빛나다, 빛, 온기", english: "radiance" },
  { korean: "내집단", english: "ingroup" },
  { korean: "잘 알고 있는", english: "informed" },
  { korean: "(진로·계획 등을) 벗어나게 하다", english: "derail" },
  { korean: "수술복", english: "scrubs" },
  { korean: "완전히", english: "entirely" },
  ...
  { korean: "무의식적으로, 무심코", english: "unconsciously" },
  { korean: "~대(對), ~에 비해", english: "versus" },
  { korean: "반전, 역전, 번복", english: "reversal" },
  { korean: "어색한, 서투른", english: "awkward" },
  { korean: "중심 체온", english: "core temperature" },
  { korean: "서랍", english: "drawer" },
  { korean: "되는 대로의, 운에 맡기는", english: "random" },
  { korean: "~에도 적용되다", english: "apply to" },
  { korean: "진지하게, 본격적으로", english: "in earnest" },
  { korean: "편안하게 해주는", english: "soothing" },
